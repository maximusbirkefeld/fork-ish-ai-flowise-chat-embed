...
export const SendButton = (props: SendButtonProps) => {
  return (
    <button
      ...
      {...props}
      class={
        'py-2 px-4 justify-center font-semibold text-white flex items-center disabled:opacity-50 disabled:cursor-not-allowed disabled:brightness-100 transition-all filter hover:brightness-90 active:brightness-75 chatbot-button chatbot-focus-ring ' +
        props.class
      }
...
export const DeleteButton = (props: SendButtonProps) => {
  ...
  return (
    <button
      ...
      {...props}
      class={
        `py-2 ${paddingClass} justify-center font-semibold text-white flex items-center disabled:opacity-50 disabled:cursor-not-allowed disabled:brightness-100 transition-all filter hover:brightness-90 active:brightness-75 chatbot-button chatbot-focus-ring ` +
        props.class
      }
      style={{ background: 'transparent', border: 'none' }}
      title="Reset Chat"
